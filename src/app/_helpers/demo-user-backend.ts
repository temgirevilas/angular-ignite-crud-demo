...
const usersKey = 'angular-ignite-user-demo';
...
let users: any[] = usersJSON ? JSON.parse(usersJSON) : [{
    ...
    firstName: 'Vilas',
    lastName: 'Temgire', 
    email: 'vilas.temgire@xoriant.com',
    role: Role.User,
    password: '123456'
}];
...
export class DemoBackendUserInterceptor implements HttpInterceptor {
...
export const fakeBackendUserProvider = {
    // use fake backend in place of Http service for backend-less development
    provide: HTTP_INTERCEPTORS,
    useClass: DemoBackendUserInterceptor,
    multi: true
};